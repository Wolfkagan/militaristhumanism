/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false` (hash: c11ea031c736f1def53a8ab2fb02f804)
...
interface __BaseEnv_Env {
	...
	AUTH_BASE_FALLBACK: string;
	COMMUNITY_READ_ONLY: string;
	TURNSTILE_MODE: string;
	TURNSTILE_SITE_KEY: string;
	ANALYTICS_DATASET: string;
	AUTH_SECRET: string;
	AUDIT_INTEGRITY_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "CANONICAL_ORIGIN" | "AUTH_ALLOWED_HOSTS" | "AUTH_BASE_FALLBACK" | "COMMUNITY_READ_ONLY" | "TURNSTILE_MODE" | "TURNSTILE_SITE_KEY" | "ANALYTICS_DATASET" | "AUTH_SECRET" | "AUDIT_INTEGRITY_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "APPLE_CLIENT_ID" | "APPLE_TEAM_ID" | "APPLE_KEY_ID" | "APPLE_PRIVATE_KEY" | "TURNSTILE_SECRET" | "ADMIN_BOOTSTRAP_EMAILS" | "ANALYTICS_READ_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "E2E_TEST_TOKEN">> {}
}
